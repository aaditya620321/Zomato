...
df_data = pd.read_csv(r"C:\Users\aaditya\OneDrive\Documents\project data analysis\Power bi project\Zamoto project\Zamoto raw data\zomato.csv", encoding='unicode_escape')
print(df_data)


# Loading excel file of country code using pandas

df_country = pd.read_excel(r"C:\Users\aaditya\OneDrive\Documents\project data analysis\Power bi project\Zamoto project\Zamoto raw data\Country-Code.xlsx")
print(df_country)
...
#downlaod data
#df.to_csv(r"C:\Users\aaditya\OneDrive\Documents\project data analysis\Power bi project\Zamoto project\zomato.csv")
print(df.to_string)
